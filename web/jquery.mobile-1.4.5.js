(function (root, doc, factory) {
    ...
    (function ($, undefined) {
        ...
        $.extend($.support, {
            ...
            "replaceState" in history && !( window.navigator.userAgent.indexOf("Firefox") >= 0 && window.top !== window ) &&
        ...
        $.mobile._registerInternalEvents = function () {
            var getAjaxFormData = function ($form, calculateOnly) {
                ...
                if (!$.mobile.ajaxEnabled ||
                    ...
                    $form.is(":jqmData(ajax='false')") || !$form.jqmHijackable().length ||
                    $form.attr("target")) {
                    return false;
                }
            ...
            _updateBackButton: function () {
                ...
                if (this.options.addBackBtn &&
                    ...
                    ( this.page ?
                        ...
                        $.mobile.navigate.history.activeIndex > 0 ) ) && !this.leftbtn) {
